...
{
    public partial class PodgladZamowieniaAdmin : Form
    {
        String conS;
        SqlConnection sqlC;
        SqlCommand cmd = new SqlCommand();
        SqlDataReader rd;
        public PodgladZamowieniaAdmin()
        {
            InitializeComponent();
            ...
            cmd.CommandText = "select k.imie, k.nazwisko from dbo.Klient k join dbo.Zamowienie z on k.id_klienta = z.id_klienta where z.id_zamowienia = @id_zamowienia";
